...
setup(
    ...
    project_urls={
        "Documentation": "https://tket.quantinuum.com/extensions/pytket-quest/index.html",
        "Source": "https://github.com/CQCL/pytket-quest",
    ...
    install_requires=["pytket ~= 1.28", "pyquest ~= 0.0.1", "numpy >= 1.20, < 3.0.0"],
    classifiers=[
        "Environment :: Console",
